...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
	...
	if (hcan==&hcan2)
	{
		...
		if ((CAN_RxHeaderStruct.ExtId & 0xFF)==(steering_wheel.parameter.CANID))
...
//		can_filter_set(&CAN_FilterStructure_3,0x0B,0,0,STD_ID_MODE|EQUIPMENT_ID_IMPROVE);
	  ...
	  CAN_FilterStructure_2.FilterBank = 15;
		...
		#ifdef	AGV_BOARD_A
		can_filter_set(&CAN_FilterStructure_2,A_STEERING_CAN_ID,0,0,EXT_ID_MODE|EQUIPMENT_ID_NORMAL);
		#endif
		#ifdef	AGV_BOARD_B
		can_filter_set(&CAN_FilterStructure_2,B_STEERING_CAN_ID,0,0,EXT_ID_MODE|EQUIPMENT_ID_NORMAL);
		#endif
		#ifdef	AGV_BOARD_C
		can_filter_set(&CAN_FilterStructure_2,C_STEERING_CAN_ID,0,0,EXT_ID_MODE|EQUIPMENT_ID_NORMAL);
		#endif
		#ifdef	AGV_BOARD_D
		can_filter_set(&CAN_FilterStructure_2,D_STEERING_CAN_ID,0,0,EXT_ID_MODE|EQUIPMENT_ID_NORMAL);
		#endif
